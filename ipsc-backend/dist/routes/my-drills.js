...
function getTemplateByOwner(ownerUserId, id) {
    return db
...
function loadTemplateWithTargets(ownerUserId, templateId) {
    ...
    try {
        const tx = db.transaction((payload) => {
            const templateInfo = db
                .prepare(`INSERT INTO drill_templates (match_id, stage_id, owner_user_id, name, timeout, sort_order)
           VALUES (NULL, NULL, ?, ?, ?, ?)`)
