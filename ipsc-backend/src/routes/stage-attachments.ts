...
import {
  buildStoragePath,
  ensureStageUploadsDir,
  resolveStoragePath,
} from '../services/stage-files.js';
...
function stageIdFromReq(req: Request): number {
  return Number(req.params['id']);
}

function toAttachmentResponse(req: Request, row: {
  id: number;
  stage_id: number;
  match_id: number;
  filename: string;
